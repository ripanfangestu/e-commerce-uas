...
<div class="container">
	...
	<form action="proses/tm_produk.php" method="POST" enctype="multipart/form-data">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<h4>Pilih barang yang hanya dibutuhkan untuk produk</h4>
				<div class="bg-danger" style="padding: 5px;">
				<p style="color: red; font-weight: bold;">NB: Form dibawah harus diisi untuk inventory!</p>
				</div>
				<br>
				<?php 
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control"placeholder="Contoh : 1" name="keb[]">
							</div>
						</div>
					</div>
					<?php 
